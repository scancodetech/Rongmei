...
public class FormatDateTime {
  ...
  public static String currentTimeString() {
    Date dt = new Date();
    SimpleDateFormat myFmt = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss_SSSS");
    return myFmt.format(dt);
  }

  public static String currentRandomTimeString() {
    Date dt = new Date();
    SimpleDateFormat myFmt = new SimpleDateFormat("yyyyMMddHHmmssSSSS");
    return myFmt.format(dt) + RandomUtil.generateCode(3);
  }
}
