        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                try {
                    ...
                    try {
                        await api.distributionService.getUserDistributionWithUsername(values.phone);
                    } catch (e) {
                        if (e.toString().indexOf("404") >= 0) {
                            await api.distributionService.updateUserDistribution({
        ...
        return (
            <div className={this.props.className}>
                ...
                <Form onSubmit={this.loginSubmit}>
                    <Form.Item help={getFieldError('phone') &&
                    <PromptBox info={getFieldError('phone')} width={calculateWidth(getFieldError('phone'))}/>}>
