...
public class BlindBoxNFTDetailResponse extends Response {
  ...
  public BlindBoxNFTDetailResponse() {
  }

  public BlindBoxNFTDetailResponse(int nftId, String name, String url, int price,
