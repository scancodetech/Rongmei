...
public class BlindBoxSaleDetailResponse extends Response {
  ...
  public BlindBoxSaleDetailResponse() {
  }

  public BlindBoxSaleDetailResponse(int saleId, int blindBoxNftId, String name, String url,
      int price,
      String description, String author, String owner, String tokenId, String theme,
      String classification, String chainTxId, String confirmationLetterUrl, long createTime,
      long updateTime, boolean isActive, int likeNum) {
    this.saleId = saleId;
