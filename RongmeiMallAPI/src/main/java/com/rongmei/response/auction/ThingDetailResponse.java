...
public class ThingDetailResponse extends Response {
  ...
  public ThingDetailResponse() {
  }

  public ThingDetailResponse(int id, String name, String url, double price,
      String description, long createTime, String author, String owner, String tokenId,
      List<String> tags, String chainTxId, String confirmationLetterUrl) {
    this.id = id;
    this.name = name;
    this.url = url;
    this.price = price;
