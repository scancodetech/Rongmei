...
public class ProposalDetailResponse extends Response {
  ...
  public ProposalDetailResponse(int id, String content, int relationId, String proposalType,
      int passStandard, int promulgateStandard, String status, long startTime, long endTime,
      long createTime, long updateTime, int visibility, String painterName,
      String painterSampleUrl, int workPeriod, int completionDegree, long voteEndTime, int price,
      int agreeNum, int disagreeNum) {
    this.id = id;
