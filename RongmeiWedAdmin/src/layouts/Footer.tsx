          ...
          <Row gutter={{ sm: 16, md: 24, lg: 32 }}>
            ...
            <Col className="gutter-row" span={4}>
              <span style={{ marginLeft: 100, marginTop: 20, height: 200, float: 'left' }}>
                ...
                <br />
                <a href="http://www.dimension.pub" target='_blank' className={footerStyles.footerItemContent}>跨次元内容数字资产交易平台</a>
              </span>
            </Col>
            <Col className="gutter-row" span={4}>
              <span style={{ marginLeft: 100, marginTop: 20, height: 200, float: 'left' }}>
            ...
            <Col className="gutter-row" span={4}>
              <span style={{ marginLeft: 100, marginTop: 20, height: 200, float: 'left' }}>
                ...
                <a target='_blank' href="/picadmin/#/protocol/private" className={footerStyles.footerItemContent}>隐私协议</a>
                <br />
                <a target='_blank' href="/picadmin/#/protocol/platform" className={footerStyles.footerItemContent}>平台协议</a>
                <br />
