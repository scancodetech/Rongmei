        ...
        return (
            <div style={{
                ...
                <Modal
                    ...
                    className='addModalChange'
                >
                    <div>
                        {/*<Button onClick={() => { this.setState({ showAddModal: false }, () => { this.props.history.push('/chh') }) }}>抽盒盒</Button>*/}

                        <Button onClick={() => { this.setState({ showAddModal: false }, () => { this.props.history.push('/phh') }) }}>拼盒盒</Button>
                        <Button onClick={() => { this.setState({ showAddModal: false }, () => { this.props.history.push('/liuhaizi') }) }}>遛设</Button>
