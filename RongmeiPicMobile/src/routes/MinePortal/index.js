                            ...
                            <WhiteSpace size='lg' />
                            {
                                ...
                                <Flex justify='around'>
                                    <Flex justify='around' align='start'>
                                        <div style={{ fontSize: 12, width: 120, textAlign: 'center' }}>藏品缩略图：</div>
                                        <div>
                                            <img alt='' src={this.state.thingUrl} style={{ width: 150, height: 190, objectFit: 'contain' }} />
                                        </div>
                                    </Flex>
                                </Flex>
                            }
