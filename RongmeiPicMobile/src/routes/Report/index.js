...
import {ActionSheet, ImagePicker, PickerView, Toast, WingBlank} from 'antd-mobile';
...
class Report extends React.Component {
    ...
    render() {
        return (
            <div className='page' style={{height: window.innerHeight - 50}}>
                {/* 页面头部 */}
                <Header title={'举报'} theme={{bgColor: 'black', title: 'white', mode: 'dark'}}>
                </Header>
