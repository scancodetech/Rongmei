...
export const OUTER_API_SERVICE = "rongmei.outer.api";
export const DISTRIBUTION_SERVICE = "rongmei.distribution.api"
...
export const httpOuter = new HttpService(OUTER_API_SERVICE);
export const httpDistribution = new HttpService(DISTRIBUTION_SERVICE);
