...
public class UserGroupApplicationResponse extends Response {
  ...
  public UserGroupApplicationResponse(int id, String title, String signature,
      String avatarUrl, int orgType, String orgName, String orgCertification,
      String businessLicenseUrl, String officialLetterUrl, String otherFileUrl,
      String operatorName, String operatorIdentityCard, String operatorPhone,
      String username, long createTime, long updateTime, boolean isApprove,
      String approveMsg) {
    this.id = id;
    this.title = title;
